...
extension ViewImageConfig {
	...
	/// Get view image configuration for a iPhone 17 Pro
	...
	public static func iPhone17Pro(_ orientation: Orientation) -> ViewImageConfig {
		...
		switch orientation {
			case .landscape:
				safeArea = .init(top: 20, left: 62, bottom: 21, right: 62)
		...
		return .init(
			safeArea: safeArea, size: size, traits: UITraitCollection.iPhone17Pro(orientation))
	}
}

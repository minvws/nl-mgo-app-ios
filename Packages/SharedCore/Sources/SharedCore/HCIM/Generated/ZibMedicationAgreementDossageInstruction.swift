...
//
//   let zibMedicationAgreementDossageInstruction = try ZibMedicationAgreementDossageInstruction(json)
//
...
// MARK: - ZibMedicationAgreementDossageInstruction
public struct ZibMedicationAgreementDossageInstruction: Codable, Hashable, Sendable {
...
// MARK: ZibMedicationAgreementDossageInstruction convenience initializers and mutators

public extension ZibMedicationAgreementDossageInstruction {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibMedicationAgreementDossageInstruction.self, from: data)
    }
    ...
    ) -> ZibMedicationAgreementDossageInstruction {
        return ZibMedicationAgreementDossageInstruction(

...
// MARK: - Icpc
public struct Icpc: Codable, Hashable, Sendable {
...
// MARK: Icpc convenience initializers and mutators

public extension Icpc {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(Icpc.self, from: data)
    }

...
//
//   let nlCorePractitionerRoleTelecom = try NlCorePractitionerRoleTelecom(json)
//
...
// MARK: - NlCorePractitionerRoleTelecom
public struct NlCorePractitionerRoleTelecom: Codable, Hashable, Sendable {
...
// MARK: NlCorePractitionerRoleTelecom convenience initializers and mutators

public extension NlCorePractitionerRoleTelecom {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(NlCorePractitionerRoleTelecom.self, from: data)
    }
    ...
    func with(
        ...
        value: MgoString?? = nil
    ) -> NlCorePractitionerRoleTelecom {
        return NlCorePractitionerRoleTelecom(

...
//
//   let r4NlCorePatientTelecom = try R4NlCorePatientTelecom(json)
//
...
// MARK: - R4NlCorePatientTelecom
public struct R4NlCorePatientTelecom: Codable, Hashable, Sendable {
...
// MARK: R4NlCorePatientTelecom convenience initializers and mutators

public extension R4NlCorePatientTelecom {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(R4NlCorePatientTelecom.self, from: data)
    }
    ...
    ) -> R4NlCorePatientTelecom {
        return R4NlCorePatientTelecom(

...
//
//   let legalStatus = try LegalStatus(json)
//
...
// MARK: - LegalStatus
public struct LegalStatus: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: LegalStatus convenience initializers and mutators

public extension LegalStatus {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(LegalStatus.self, from: data)
    }

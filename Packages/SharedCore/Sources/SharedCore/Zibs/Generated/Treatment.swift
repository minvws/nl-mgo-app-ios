...
//
//   let treatment = try Treatment(json)
//
...
// MARK: - Treatment
public struct Treatment: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: Treatment convenience initializers and mutators

public extension Treatment {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(Treatment.self, from: data)
    }

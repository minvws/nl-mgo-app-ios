...
//
//   let diastolicEndpoint = try DiastolicEndpoint(json)
//
...
// MARK: DiastolicEndpoint convenience initializers and mutators

public extension DiastolicEndpoint {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(DiastolicEndpoint.self, from: data)
    }

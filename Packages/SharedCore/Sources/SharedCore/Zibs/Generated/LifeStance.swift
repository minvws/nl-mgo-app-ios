...
//
//   let lifeStance = try LifeStance(json)
//
...
// MARK: - LifeStance
public struct LifeStance: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: LifeStance convenience initializers and mutators

public extension LifeStance {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(LifeStance.self, from: data)
    }

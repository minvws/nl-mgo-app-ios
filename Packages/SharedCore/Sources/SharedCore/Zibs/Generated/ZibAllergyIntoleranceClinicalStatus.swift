...
//
//   let zibAllergyIntoleranceClinicalStatus = try ZibAllergyIntoleranceClinicalStatus(json)
//
...
// MARK: ZibAllergyIntoleranceClinicalStatus convenience initializers and mutators

public extension ZibAllergyIntoleranceClinicalStatus {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibAllergyIntoleranceClinicalStatus.self, from: data)
    }

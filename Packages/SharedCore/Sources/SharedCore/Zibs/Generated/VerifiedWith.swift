...
//
//   let verifiedWith = try VerifiedWith(json)
//
...
// MARK: - VerifiedWith
public struct VerifiedWith: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: VerifiedWith convenience initializers and mutators

public extension VerifiedWith {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(VerifiedWith.self, from: data)
    }

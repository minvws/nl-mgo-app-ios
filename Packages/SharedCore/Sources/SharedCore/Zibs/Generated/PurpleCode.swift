...
//
//   let purpleCode = try PurpleCode(json)
//
...
// MARK: - PurpleCode
public struct PurpleCode: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: PurpleCode convenience initializers and mutators

public extension PurpleCode {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(PurpleCode.self, from: data)
    }

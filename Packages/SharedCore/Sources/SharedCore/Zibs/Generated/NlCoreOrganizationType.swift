...
//
//   let nlCoreOrganizationType = try NlCoreOrganizationType(json)
//
...
// MARK: - NlCoreOrganizationType
public struct NlCoreOrganizationType: Codable, Hashable, Sendable {
...
// MARK: NlCoreOrganizationType convenience initializers and mutators

public extension NlCoreOrganizationType {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(NlCoreOrganizationType.self, from: data)
    }
    ...
    ) -> NlCoreOrganizationType {
        return NlCoreOrganizationType(

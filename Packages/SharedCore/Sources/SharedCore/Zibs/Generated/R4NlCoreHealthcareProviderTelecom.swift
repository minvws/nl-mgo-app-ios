...
//
//   let r4NlCoreHealthcareProviderTelecom = try R4NlCoreHealthcareProviderTelecom(json)
//
...
// MARK: - R4NlCoreHealthcareProviderTelecom
public struct R4NlCoreHealthcareProviderTelecom: Codable, Hashable, Sendable {
...
// MARK: R4NlCoreHealthcareProviderTelecom convenience initializers and mutators

public extension R4NlCoreHealthcareProviderTelecom {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(R4NlCoreHealthcareProviderTelecom.self, from: data)
    }
    ...
    ) -> R4NlCoreHealthcareProviderTelecom {
        return R4NlCoreHealthcareProviderTelecom(

...
//
//   let zibMedicalDeviceRequestStatus = try ZibMedicalDeviceRequestStatus(json)
//
...
// MARK: ZibMedicalDeviceRequestStatus convenience initializers and mutators

public extension ZibMedicalDeviceRequestStatus {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibMedicalDeviceRequestStatus.self, from: data)
    }

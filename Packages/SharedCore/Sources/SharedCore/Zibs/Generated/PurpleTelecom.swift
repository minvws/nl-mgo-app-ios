...
//
//   let purpleTelecom = try PurpleTelecom(json)
//
...
// MARK: - PurpleTelecom
public struct PurpleTelecom: Codable, Hashable, Sendable {
...
// MARK: PurpleTelecom convenience initializers and mutators

public extension PurpleTelecom {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(PurpleTelecom.self, from: data)
    }

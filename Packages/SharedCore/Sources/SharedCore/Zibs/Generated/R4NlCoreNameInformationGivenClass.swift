...
//
//   let r4NlCoreNameInformationGivenClass = try R4NlCoreNameInformationGivenClass(json)
//
...
// MARK: R4NlCoreNameInformationGivenClass convenience initializers and mutators

public extension R4NlCoreNameInformationGivenClass {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(R4NlCoreNameInformationGivenClass.self, from: data)
    }

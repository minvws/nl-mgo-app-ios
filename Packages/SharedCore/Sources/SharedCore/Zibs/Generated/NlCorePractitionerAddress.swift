...
//
//   let nlCorePractitionerAddress = try NlCorePractitionerAddress(json)
//
...
// MARK: - NlCorePractitionerAddress
public struct NlCorePractitionerAddress: Codable, Hashable, Sendable {
    ...
    public init(profile: NlCoreAddressProfile, addressType: MgoCodeableConcept?, city: MgoString?, country: MgoString?, district: MgoString?, line: [TentacledLine]?, official: MgoBoolean?, postalCode: MgoString?, type: NlCoreOrganizationTelecomSystem?, use: NlCoreOrganizationTelecomSystem?) {
...
// MARK: NlCorePractitionerAddress convenience initializers and mutators

public extension NlCorePractitionerAddress {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(NlCorePractitionerAddress.self, from: data)
    }
    ...
    ) -> NlCorePractitionerAddress {
        return NlCorePractitionerAddress(

...
public struct IheMhdMinimalDocumentReference: Codable, Hashable, Sendable {
    ...
    public init(author: [MgoReference]?, iheMhdMinimalDocumentReferenceClass: MgoCodeableConcept?, content: Content, context: Context, fhirVersion: FhirVersionR3, id: String?, identifier: [MgoIdentifier]?, indexed: MgoInstant?, masterIdentifier: MgoIdentifier?, profile: IheMhdMinimalDocumentReferenceProfile, referenceID: String, relatesTo: [RelatesTo]?, resourceType: String, securityLabel: [MgoCodeableConcept]?, status: IheMhdMinimalDocumentReferenceStatus?, subject: MgoReference?, type: MgoCodeableConcept?) {
        self.author = author

...
//
//   let fluffyCode = try FluffyCode(json)
//
...
// MARK: - FluffyCode
public struct FluffyCode: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: FluffyCode convenience initializers and mutators

public extension FluffyCode {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(FluffyCode.self, from: data)
    }

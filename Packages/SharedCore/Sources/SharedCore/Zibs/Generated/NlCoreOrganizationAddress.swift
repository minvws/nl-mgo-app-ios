...
public struct NlCoreOrganizationAddress: Codable, Hashable, Sendable {
    ...
    public init(profile: NlCoreAddressProfile, addressType: MgoCodeableConcept?, city: MgoString?, country: MgoString?, district: MgoString?, line: [PurpleLine]?, official: MgoBoolean?, postalCode: MgoString?, type: NlCoreOrganizationTelecomSystem?, use: NlCoreOrganizationTelecomSystem?) {

...
//
//   let communication = try Communication(json)
//
...
// MARK: Communication convenience initializers and mutators

public extension Communication {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(Communication.self, from: data)
    }
    ...
    func with(
        ...
        return Communication(
            ...
            preferred: preferred ?? self.preferred
        )
    }

...
public struct EAfspraakAppointment: Codable, Hashable, Sendable {
    ...
    public let onlineEditable: ExtensionValueOfStructure0_478704391013798?
    ...
    public init(appointmentType: MgoCodeableConcept?, created: PrimitiveValueTypeOfDateTimeDateTimeString?, description: PrimitiveValueTypeOfStringString?, end: PrimitiveValueTypeOfDateTimeDateTimeString?, fhirVersion: NlCoreObservationFhirVersion, id: String?, identifier: [MgoIdentifier]?, incomingReferral: [MgoReference]?, indication: [MgoReference]?, minutesDuration: MgoPositiveInt?, onlineEditable: ExtensionValueOfStructure0_478704391013798?, participant: [EAfspraakAppointmentParticipant]?, patientInstructions: [ExtensionValueOfMgoString], profile: EAfspraakAppointmentProfile, reason: [MgoCodeableConcept]?, referenceID: String, resourceType: String, serviceCategory: MgoCodeableConcept?, specialty: [MgoCodeableConcept]?, start: PrimitiveValueTypeOfDateTimeDateTimeString?, status: EAfspraakAppointmentStatus) {
...
public extension EAfspraakAppointment {
    ...
    func with(
        ...
        onlineEditable: ExtensionValueOfStructure0_478704391013798?? = nil,

...
//
//   let r4ImmVaccinationEvent = try R4ImmVaccinationEvent(json)
//
...
// MARK: - R4ImmVaccinationEvent
public struct R4ImmVaccinationEvent: Codable, Hashable, Sendable {
    ...
    public let performer: [R4ImmVaccinationEventPerformer]?
    public let pharmaceuticalProduct: ExtensionValueOfMgoReference?
    public let profile: R4ImmVaccinationEventProfile
    ...
    public init(doseQuantity: MgoQuantity?, fhirVersion: R4BBSDocumentReferenceFhirVersion, id: String?, identifier: [MgoIdentifier]?, location: MgoReference?, note: [MgoAnnotation]?, occurrenceDateTime: MgoDateTime?, occurrenceString: MgoString?, patient: MgoReference?, performer: [R4ImmVaccinationEventPerformer]?, pharmaceuticalProduct: ExtensionValueOfMgoReference?, profile: R4ImmVaccinationEventProfile, protocolApplied: [ProtocolApplied]?, reasonCode: ReasonCode, referenceID: String, resourceType: String, route: MgoCodeableConcept?, status: MgoCodeOfString?, vaccineCode: MgoCodeableConcept?) {
...
// MARK: R4ImmVaccinationEvent convenience initializers and mutators

public extension R4ImmVaccinationEvent {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(R4ImmVaccinationEvent.self, from: data)
    }
    ...
    func with(
        ...
        performer: [R4ImmVaccinationEventPerformer]?? = nil,
        pharmaceuticalProduct: ExtensionValueOfMgoReference?? = nil,
        profile: R4ImmVaccinationEventProfile? = nil,
    ...
    ) -> R4ImmVaccinationEvent {
        return R4ImmVaccinationEvent(

...
//
//   let contactTelecom = try ContactTelecom(json)
//
...
// MARK: - ContactTelecom
public struct ContactTelecom: Codable, Hashable, Sendable {
...
// MARK: ContactTelecom convenience initializers and mutators

public extension ContactTelecom {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ContactTelecom.self, from: data)
    }

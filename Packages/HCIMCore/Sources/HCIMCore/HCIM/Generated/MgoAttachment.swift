...
public struct MgoAttachment: Codable, Hashable, Sendable {
    ...
    public enum CodingKeys: String, CodingKey {
        case type = "_type"
        case contentType, creation, data, hash, language, size, title, url
    }

    public init(type: MgoAttachmentType, contentType: String?, creation: String?, data: String?, hash: String?, language: String?, size: Double?, title: String?, url: String?) {
        self.type = type

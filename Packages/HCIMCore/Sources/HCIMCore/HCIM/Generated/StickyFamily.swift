...
//
//   let stickyFamily = try StickyFamily(json)
//
...
// MARK: - StickyFamily
public struct StickyFamily: Codable, Hashable, Sendable {
...
// MARK: StickyFamily convenience initializers and mutators

public extension StickyFamily {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(StickyFamily.self, from: data)
    }

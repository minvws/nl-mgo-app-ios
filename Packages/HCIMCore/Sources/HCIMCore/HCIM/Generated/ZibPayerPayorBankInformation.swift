...
//
//   let zibPayerPayorBankInformation = try ZibPayerPayorBankInformation(json)
//
...
// MARK: - ZibPayerPayorBankInformation
public struct ZibPayerPayorBankInformation: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: ZibPayerPayorBankInformation convenience initializers and mutators

public extension ZibPayerPayorBankInformation {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibPayerPayorBankInformation.self, from: data)
    }
    ...
    ) -> ZibPayerPayorBankInformation {
        return ZibPayerPayorBankInformation(
            ext: ext ?? self.ext,

...
public struct ZibTobaccoUse: Codable, Hashable, Sendable {
    ...
    public let component: ZibTobaccoUseComponent?
    ...
    public init(comment: MgoString?, component: ZibTobaccoUseComponent?, effectivePeriod: MgoPeriod?, fhirVersion: EAfspraakAppointmentFhirVersion, id: String?, identifier: [MgoIdentifier]?, performer: [MgoReference]?, profile: ZibTobaccoUseProfile, referenceID: String, resourceType: String, subject: MgoReference?, valueCodeableConcept: MgoCodeableConcept?) {
...
public extension ZibTobaccoUse {
    ...
    func with(
        ...
        component: ZibTobaccoUseComponent?? = nil,

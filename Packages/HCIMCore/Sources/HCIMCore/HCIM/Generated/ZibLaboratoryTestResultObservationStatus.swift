...
//
//   let zibLaboratoryTestResultObservationStatus = try ZibLaboratoryTestResultObservationStatus(json)
//
...
// MARK: ZibLaboratoryTestResultObservationStatus convenience initializers and mutators

public extension ZibLaboratoryTestResultObservationStatus {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibLaboratoryTestResultObservationStatus.self, from: data)
    }

...
//
//   let gpDiagnosticResultStatus = try GpDiagnosticResultStatus(json)
//
...
// MARK: GpDiagnosticResultStatus convenience initializers and mutators

public extension GpDiagnosticResultStatus {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(GpDiagnosticResultStatus.self, from: data)
    }

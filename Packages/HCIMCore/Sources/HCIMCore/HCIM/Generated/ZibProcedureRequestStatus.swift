...
//
//   let zibProcedureRequestStatus = try ZibProcedureRequestStatus(json)
//
...
// MARK: ZibProcedureRequestStatus convenience initializers and mutators

public extension ZibProcedureRequestStatus {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibProcedureRequestStatus.self, from: data)
    }

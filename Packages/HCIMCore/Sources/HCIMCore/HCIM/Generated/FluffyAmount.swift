...
//
//   let fluffyAmount = try FluffyAmount(json)
//
...
// MARK: FluffyAmount convenience initializers and mutators

public extension FluffyAmount {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(FluffyAmount.self, from: data)
    }

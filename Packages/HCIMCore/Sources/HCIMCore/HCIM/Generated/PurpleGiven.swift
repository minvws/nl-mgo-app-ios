...
//
//   let purpleGiven = try PurpleGiven(json)
//
...
// MARK: PurpleGiven convenience initializers and mutators

public extension PurpleGiven {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(PurpleGiven.self, from: data)
    }

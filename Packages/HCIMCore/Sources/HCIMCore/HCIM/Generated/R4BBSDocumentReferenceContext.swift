...
//
//   let r4BBSDocumentReferenceContext = try R4BBSDocumentReferenceContext(json)
//
...
// MARK: - R4BBSDocumentReferenceContext
public struct R4BBSDocumentReferenceContext: Codable, Hashable, Sendable {
...
// MARK: R4BBSDocumentReferenceContext convenience initializers and mutators

public extension R4BBSDocumentReferenceContext {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(R4BBSDocumentReferenceContext.self, from: data)
    }
    ...
    ) -> R4BBSDocumentReferenceContext {
        return R4BBSDocumentReferenceContext(

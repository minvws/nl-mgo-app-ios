...
public struct Payor: Codable, Hashable, Sendable {
    ...
    public let bankInformation: [ExtensionValueOfStructure0_9215048426710553]
    ...
    public init(type: MgoReferenceType?, bankInformation: [ExtensionValueOfStructure0_9215048426710553], display: String?, reference: String?) {
        self.type = type
...
public extension Payor {
    ...
    func with(
        ...
        bankInformation: [ExtensionValueOfStructure0_9215048426710553]? = nil,
        display: String?? = nil,

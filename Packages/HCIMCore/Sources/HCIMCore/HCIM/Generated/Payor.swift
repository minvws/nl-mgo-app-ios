...
public struct Payor: Codable, Hashable, Sendable {
    ...
    public let bankInformation: [ExtensionValueOfStructure0_40324747767269975]
    ...
    public init(type: MgoReferenceType?, bankInformation: [ExtensionValueOfStructure0_40324747767269975], display: String?, reference: String?) {
        self.type = type
...
public extension Payor {
    ...
    func with(
        ...
        bankInformation: [ExtensionValueOfStructure0_40324747767269975]? = nil,
        display: String?? = nil,

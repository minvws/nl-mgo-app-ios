...
public struct Payor: Codable, Hashable, Sendable {
    ...
    public let bankInformation: [ExtensionValueOfStructure0_930843438080291]
    ...
    public init(type: MgoReferenceType?, bankInformation: [ExtensionValueOfStructure0_930843438080291], display: String?, reference: String?) {
        self.type = type
...
public extension Payor {
    ...
    func with(
        ...
        bankInformation: [ExtensionValueOfStructure0_930843438080291]? = nil,
        display: String?? = nil,

...
public struct Payor: Codable, Hashable, Sendable {
    ...
    public let bankInformation: [ZibPayerPayorBankInformation]
    ...
    public init(type: MgoReferenceType?, bankInformation: [ZibPayerPayorBankInformation], display: String?, reference: String?) {
        self.type = type
...
public extension Payor {
    ...
    func with(
        ...
        bankInformation: [ZibPayerPayorBankInformation]? = nil,
        display: String?? = nil,

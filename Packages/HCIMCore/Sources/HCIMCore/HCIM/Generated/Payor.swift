...
public struct Payor: Codable, Hashable, Sendable {
    ...
    public let bankInformation: [ExtensionValueOfStructure0_7756640173029994]
    ...
    public init(type: MgoReferenceType?, bankInformation: [ExtensionValueOfStructure0_7756640173029994], display: String?, reference: String?) {
        self.type = type
...
public extension Payor {
    ...
    func with(
        ...
        bankInformation: [ExtensionValueOfStructure0_7756640173029994]? = nil,
        display: String?? = nil,

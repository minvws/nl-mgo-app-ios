...
public struct NlCoreCarePlan: Codable, Hashable, Sendable {
    ...
    public init(activity: [Activity]?, fhirVersion: NlCoreObservationFhirVersion, goal: [MgoReference]?, id: String?, identifier: [MgoIdentifier]?, period: MgoPeriod?, profile: NlCoreCarePlanProfile, referenceID: String, resourceType: String, subject: MgoReference?) {

...
//
//   let indigoLine = try IndigoLine(json)
//
...
// MARK: IndigoLine convenience initializers and mutators

public extension IndigoLine {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(IndigoLine.self, from: data)
    }

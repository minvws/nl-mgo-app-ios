...
//
//   let verificationStatus = try VerificationStatus(json)
//
...
// MARK: VerificationStatus convenience initializers and mutators

public extension VerificationStatus {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(VerificationStatus.self, from: data)
    }

...
//
//   let extensionValueOfStructure03355230919728662 = try ExtensionValueOfStructure0_3355230919728662(json)
//
...
// MARK: - ExtensionValueOfStructure0_3355230919728662
public struct ExtensionValueOfStructure0_3355230919728662: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: ExtensionValueOfStructure0_3355230919728662 convenience initializers and mutators

public extension ExtensionValueOfStructure0_3355230919728662 {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ExtensionValueOfStructure0_3355230919728662.self, from: data)
    }
    ...
    ) -> ExtensionValueOfStructure0_3355230919728662 {
        return ExtensionValueOfStructure0_3355230919728662(
            ext: ext ?? self.ext,

...
//
//   let r4NlCoreContactInformation = try R4NlCoreContactInformation(json)
//
...
// MARK: - R4NlCoreContactInformation
public struct R4NlCoreContactInformation: Codable, Hashable, Sendable {
...
// MARK: R4NlCoreContactInformation convenience initializers and mutators

public extension R4NlCoreContactInformation {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(R4NlCoreContactInformation.self, from: data)
    }
    ...
    func with(
        ...
        return R4NlCoreContactInformation(

...
//
//   let fluffyFamily = try FluffyFamily(json)
//
...
// MARK: - FluffyFamily
public struct FluffyFamily: Codable, Hashable, Sendable {
...
// MARK: FluffyFamily convenience initializers and mutators

public extension FluffyFamily {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(FluffyFamily.self, from: data)
    }

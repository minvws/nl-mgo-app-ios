...
//
//   let purpleFamily = try PurpleFamily(json)
//
...
// MARK: - PurpleFamily
public struct PurpleFamily: Codable, Hashable, Sendable {
...
// MARK: PurpleFamily convenience initializers and mutators

public extension PurpleFamily {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(PurpleFamily.self, from: data)
    }

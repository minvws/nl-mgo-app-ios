...
//
//   let zibTreatmentDirectiveVerification = try ZibTreatmentDirectiveVerification(json)
//
...
// MARK: - ZibTreatmentDirectiveVerification
public struct ZibTreatmentDirectiveVerification: Codable, Hashable, Sendable {
    public let ext: Bool
...
// MARK: ZibTreatmentDirectiveVerification convenience initializers and mutators

public extension ZibTreatmentDirectiveVerification {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibTreatmentDirectiveVerification.self, from: data)
    }
    ...
    ) -> ZibTreatmentDirectiveVerification {
        return ZibTreatmentDirectiveVerification(
            ext: ext ?? self.ext,

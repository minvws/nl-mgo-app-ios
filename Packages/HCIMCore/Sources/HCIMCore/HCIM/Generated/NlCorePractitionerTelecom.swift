...
//
//   let nlCorePractitionerTelecom = try NlCorePractitionerTelecom(json)
//
...
// MARK: - NlCorePractitionerTelecom
public struct NlCorePractitionerTelecom: Codable, Hashable, Sendable {
...
// MARK: NlCorePractitionerTelecom convenience initializers and mutators

public extension NlCorePractitionerTelecom {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(NlCorePractitionerTelecom.self, from: data)
    }
    ...
    func with(
        ...
        value: MgoString?? = nil
    ) -> NlCorePractitionerTelecom {
        return NlCorePractitionerTelecom(

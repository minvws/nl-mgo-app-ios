...
//
//   let hilariousLine = try HilariousLine(json)
//
...
// MARK: - HilariousLine
public struct HilariousLine: Codable, Hashable, Sendable {
...
// MARK: HilariousLine convenience initializers and mutators

public extension HilariousLine {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(HilariousLine.self, from: data)
    }

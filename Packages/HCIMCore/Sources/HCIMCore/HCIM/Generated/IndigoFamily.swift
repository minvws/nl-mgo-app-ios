...
//
//   let indigoFamily = try IndigoFamily(json)
//
...
// MARK: - IndigoFamily
public struct IndigoFamily: Codable, Hashable, Sendable {
...
// MARK: IndigoFamily convenience initializers and mutators

public extension IndigoFamily {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(IndigoFamily.self, from: data)
    }

...
//
//   let r4NlCoreAddressInformationLine = try R4NlCoreAddressInformationLine(json)
//
...
// MARK: - R4NlCoreAddressInformationLine
public struct R4NlCoreAddressInformationLine: Codable, Hashable, Sendable {
...
// MARK: R4NlCoreAddressInformationLine convenience initializers and mutators

public extension R4NlCoreAddressInformationLine {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(R4NlCoreAddressInformationLine.self, from: data)
    }
    ...
    ) -> R4NlCoreAddressInformationLine {
        return R4NlCoreAddressInformationLine(

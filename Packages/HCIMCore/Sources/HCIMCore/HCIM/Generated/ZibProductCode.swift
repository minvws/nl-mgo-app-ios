...
//
//   let zibProductCode = try ZibProductCode(json)
//
...
// MARK: ZibProductCode convenience initializers and mutators

public extension ZibProductCode {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibProductCode.self, from: data)
    }

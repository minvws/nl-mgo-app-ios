...
//
//   let nlCoreAddressLine = try NlCoreAddressLine(json)
//
...
// MARK: NlCoreAddressLine convenience initializers and mutators

public extension NlCoreAddressLine {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(NlCoreAddressLine.self, from: data)
    }

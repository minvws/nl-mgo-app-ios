...
//
//   let tentacledFamily = try TentacledFamily(json)
//
...
// MARK: - TentacledFamily
public struct TentacledFamily: Codable, Hashable, Sendable {
...
// MARK: TentacledFamily convenience initializers and mutators

public extension TentacledFamily {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(TentacledFamily.self, from: data)
    }

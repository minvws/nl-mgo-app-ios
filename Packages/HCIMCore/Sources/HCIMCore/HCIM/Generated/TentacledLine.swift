...
//
//   let tentacledLine = try TentacledLine(json)
//
...
// MARK: - TentacledLine
public struct TentacledLine: Codable, Hashable, Sendable {
...
// MARK: TentacledLine convenience initializers and mutators

public extension TentacledLine {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(TentacledLine.self, from: data)
    }

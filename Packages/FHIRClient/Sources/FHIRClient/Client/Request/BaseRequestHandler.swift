...
*/
open class BaseRequestHandler: RequestHandler {
...
*/
open class FHIRJSONRequestHandler: BaseRequestHandler {
//	
...
*/
open class FHIRDataRequestHandler: BaseRequestHandler {
	
	public let contentType: String
	
	public init(_ method: RequestMethod, contentType: String) {
		self.contentType = contentType
		super.init(method, resource: nil)
	}
	
	public required init(_ method: RequestMethod, resource: Resource?) {
		contentType = ""

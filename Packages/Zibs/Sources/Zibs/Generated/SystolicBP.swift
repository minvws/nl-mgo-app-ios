...
//
//   let systolicBP = try SystolicBP(json)
//
...
// MARK: SystolicBP convenience initializers and mutators

public extension SystolicBP {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(SystolicBP.self, from: data)
    }

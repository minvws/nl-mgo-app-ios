...
public struct ZibAlcoholUse: Codable, Hashable, Sendable {
    ...
    public init(bodySite: [MgoCoding]?, category: [[MgoCoding]]?, comment: String?, context: MgoReference?, dataAbsentReason: [MgoCoding]?, effectivePeriod: MgoPeriod?, id: String?, identifier: [MgoIdentifier]?, profile: ZibAlcoholUseProfile, referenceID: String, resourceType: String?, status: String?, subject: MgoReference?) {

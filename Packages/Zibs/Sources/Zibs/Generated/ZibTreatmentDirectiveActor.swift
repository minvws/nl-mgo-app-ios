...
//
//   let zibTreatmentDirectiveActor = try ZibTreatmentDirectiveActor(json)
//
...
// MARK: ZibTreatmentDirectiveActor convenience initializers and mutators

public extension ZibTreatmentDirectiveActor {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(ZibTreatmentDirectiveActor.self, from: data)
    }

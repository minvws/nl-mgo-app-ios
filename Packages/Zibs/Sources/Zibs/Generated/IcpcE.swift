...
// MARK: - IcpcE
public struct IcpcE: Codable, Hashable, Sendable {
...
// MARK: IcpcE convenience initializers and mutators

public extension IcpcE {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(IcpcE.self, from: data)
    }

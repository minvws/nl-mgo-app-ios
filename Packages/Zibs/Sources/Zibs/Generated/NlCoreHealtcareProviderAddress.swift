...
//
//   let nlCoreHealtcareProviderAddress = try NlCoreHealtcareProviderAddress(json)
//
...
// MARK: - NlCoreHealtcareProviderAddress
public struct NlCoreHealtcareProviderAddress: Codable, Hashable, Sendable {
...
// MARK: NlCoreHealtcareProviderAddress convenience initializers and mutators

public extension NlCoreHealtcareProviderAddress {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(NlCoreHealtcareProviderAddress.self, from: data)
    }
    ...
    ) -> NlCoreHealtcareProviderAddress {
        return NlCoreHealtcareProviderAddress(

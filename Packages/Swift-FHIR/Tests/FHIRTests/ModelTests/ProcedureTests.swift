...
class ProcedureTests: XCTestCase {
	...
	func runProcedure1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-ambulation")
	...
	func runProcedure2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-appendectomy-narrative")
	...
	func runProcedure3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-biopsy")
	...
	func runProcedure4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-colon-biopsy")
	...
	func runProcedure5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-colonoscopy")
	...
	func runProcedure6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-education")
	...
	func runProcedure7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-f001-heart")
	...
	func runProcedure8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-f002-lung")
	...
	func runProcedure9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-f003-abscess")
	...
	func runProcedure10(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcedure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "procedure-example-f004-tracheotomy")

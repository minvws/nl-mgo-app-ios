...
class GroupTests: XCTestCase {
	...
	func runGroup1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRGroup {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "group-example-member")
	...
	func runGroup2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRGroup {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "group-example")

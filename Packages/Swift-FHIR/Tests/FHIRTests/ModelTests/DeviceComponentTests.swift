...
class DeviceComponentTests: XCTestCase {
	...
	func runDeviceComponent1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDeviceComponent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "devicecomponent-example-prodspec")
	...
	func runDeviceComponent2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDeviceComponent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "devicecomponent-example")

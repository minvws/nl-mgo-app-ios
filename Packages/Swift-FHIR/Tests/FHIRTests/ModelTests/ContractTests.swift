...
class ContractTests: XCTestCase {
	...
	func runContract1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "contract-example-42cfr-part2")
	...
	func runContract2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "contract-example")
	...
	func runContract3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "contract-pcd-example-notAuthor")
	...
	func runContract4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "contract-pcd-example-notLabs")
	...
	func runContract5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "contract-pcd-example-notOrg")
	...
	func runContract6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "contract-pcd-example-notThem")
	...
	func runContract7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "contract-pcd-example-notThis")

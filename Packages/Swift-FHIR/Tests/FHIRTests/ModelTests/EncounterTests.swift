...
class EncounterTests: XCTestCase {
	...
	func runEncounter1(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-emerg")
		...
		XCTAssertEqual(inst.classHistory?[0].`class`?.system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		...
		XCTAssertEqual(inst.classHistory?[1].`class`?.system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		...
		XCTAssertEqual(inst.hospitalization?.admitSource?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/admit-source")
	...
	func runEncounter2(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-f001-heart")
	...
	func runEncounter3(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-f002-lung")
	...
	func runEncounter4(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-f003-abscess")
	...
	func runEncounter5(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-f201-20130404")
	...
	func runEncounter6(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-f202-20130128")
	...
	func runEncounter7(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-f203-20130311")
	...
	func runEncounter8(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-home")
	...
	func runEncounter9(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example-xcda")
	...
	func runEncounter10(_ json: FHIRJSON? = nil) throws -> SwiftFHIREncounter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "encounter-example")

...
class LibraryTests: XCTestCase {
	...
	func runLibrary1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLibrary {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "library-cms146-example")
		...
		XCTAssertEqual(inst.dataRequirement?[1].codeFilter?[0].valueCode?[0], "diagnosis")
		XCTAssertEqual(inst.dataRequirement?[1].codeFilter?[1].path, "clinicalStatus")
		XCTAssertEqual(inst.dataRequirement?[1].codeFilter?[1].valueCode?[0], "confirmed")
		XCTAssertEqual(inst.dataRequirement?[1].codeFilter?[2].path, "code")
		XCTAssertEqual(inst.dataRequirement?[1].codeFilter?[2].valueSetString, "2.16.840.1.113883.3.464.1003.102.12.1011")
		...
		XCTAssertEqual(inst.dataRequirement?[2].codeFilter?[2].valueSetString, "2.16.840.1.113883.3.464.1003.102.12.1012")
		XCTAssertEqual(inst.dataRequirement?[2].type, "Condition")
		XCTAssertEqual(inst.dataRequirement?[3].codeFilter?[0].path, "status")
		XCTAssertEqual(inst.dataRequirement?[3].codeFilter?[0].valueCode?[0], "finished")
		XCTAssertEqual(inst.dataRequirement?[3].codeFilter?[1].path, "class")
		XCTAssertEqual(inst.dataRequirement?[3].codeFilter?[1].valueCode?[0], "ambulatory")
		XCTAssertEqual(inst.dataRequirement?[3].codeFilter?[2].path, "type")
		XCTAssertEqual(inst.dataRequirement?[3].codeFilter?[2].valueSetString, "2.16.840.1.113883.3.464.1003.101.12.1061")
		XCTAssertEqual(inst.dataRequirement?[3].type, "Encounter")
		XCTAssertEqual(inst.dataRequirement?[4].codeFilter?[0].path, "diagnosis")
		XCTAssertEqual(inst.dataRequirement?[4].codeFilter?[0].valueSetString, "2.16.840.1.113883.3.464.1003.198.12.1012")
		XCTAssertEqual(inst.dataRequirement?[4].type, "DiagnosticReport")
		XCTAssertEqual(inst.dataRequirement?[5].codeFilter?[0].path, "code")
		XCTAssertEqual(inst.dataRequirement?[5].codeFilter?[0].valueSetString, "2.16.840.1.113883.3.464.1003.196.12.1001")
		XCTAssertEqual(inst.dataRequirement?[5].type, "Medication")
		XCTAssertEqual(inst.dataRequirement?[6].codeFilter?[0].path, "status")
		XCTAssertEqual(inst.dataRequirement?[6].codeFilter?[0].valueCode?[0], "active")
		XCTAssertEqual(inst.dataRequirement?[6].codeFilter?[1].path, "medication.code")
		XCTAssertEqual(inst.dataRequirement?[6].codeFilter?[1].valueSetString, "2.16.840.1.113883.3.464.1003.196.12.1001")
		...
		XCTAssertEqual(inst.dataRequirement?[7].codeFilter?[0].valueCode?[0], "completed")
	...
	func runLibrary2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLibrary {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "library-composition-example")
		...
		XCTAssertEqual(inst.relatedArtifact?[0].resource?.reference, "ActivityDefinition/administer-zika-virus-exposure-assessment")
		XCTAssertEqual(inst.relatedArtifact?[0].type, RelatedArtifactType(rawValue: "composed-of")!)
		XCTAssertEqual(inst.relatedArtifact?[1].resource?.reference, "ActivityDefinition/order-serum-zika-dengue-virus-igm")
		XCTAssertEqual(inst.relatedArtifact?[1].type, RelatedArtifactType(rawValue: "composed-of")!)
		XCTAssertEqual(inst.relatedArtifact?[2].resource?.reference, "ActivityDefinition/provide-mosquito-prevention-advice")
		XCTAssertEqual(inst.relatedArtifact?[2].type, RelatedArtifactType(rawValue: "composed-of")!)
		XCTAssertEqual(inst.relatedArtifact?[3].resource?.reference, "Library/zika-virus-intervention-logic")
		XCTAssertEqual(inst.relatedArtifact?[3].type, RelatedArtifactType(rawValue: "composed-of")!)
		XCTAssertEqual(inst.relatedArtifact?[4].resource?.reference, "PlanDefinition/zika-virus-intervention")
		XCTAssertEqual(inst.relatedArtifact?[4].type, RelatedArtifactType(rawValue: "composed-of")!)
		XCTAssertEqual(inst.relatedArtifact?[5].resource?.reference, "Questionnaire/zika-virus-exposure-assessment")
	...
	func runLibrary3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLibrary {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "library-example")
	...
	func runLibrary4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLibrary {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "library-predecessor-example")
		...
		XCTAssertEqual(inst.relatedArtifact?[0].resource?.reference, "Library/fhir-model-definition")
		XCTAssertEqual(inst.relatedArtifact?[0].type, RelatedArtifactType(rawValue: "depends-on")!)
		XCTAssertEqual(inst.relatedArtifact?[1].resource?.reference, "Library/library-fhir-helpers")

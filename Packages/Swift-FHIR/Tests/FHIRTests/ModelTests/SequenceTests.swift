...
class SequenceTests: XCTestCase {
	...
	func runSequence1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-coord-0base-example")
	...
	func runSequence2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-coord-1base-example")
	...
	func runSequence3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example-fda-comparison")
	...
	func runSequence4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example-fda-vcfeval")
	...
	func runSequence5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example-fda")
	...
	func runSequence6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example-pgx-1")
	...
	func runSequence7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example-pgx-2")
	...
	func runSequence8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example-TPMT-one")
	...
	func runSequence9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example-TPMT-two")
	...
	func runSequence10(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSequence {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "sequence-example")

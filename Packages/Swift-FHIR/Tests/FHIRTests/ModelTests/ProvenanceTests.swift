...
class ProvenanceTests: XCTestCase {
	...
	func runProvenance1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProvenance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "provenance-example-biocompute-object")
	...
	func runProvenance2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProvenance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "provenance-example-cwl")
	...
	func runProvenance3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProvenance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "provenance-example-sig")
	...
	func runProvenance4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProvenance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "provenance-example")

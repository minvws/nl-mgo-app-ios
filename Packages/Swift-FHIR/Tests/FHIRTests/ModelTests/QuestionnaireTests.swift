...
class QuestionnaireTests: XCTestCase {
	...
	func runQuestionnaire1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRQuestionnaire {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "questionnaire-example-bluebook")
	...
	func runQuestionnaire2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRQuestionnaire {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "questionnaire-example-f201-lifelines")
	...
	func runQuestionnaire3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRQuestionnaire {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "questionnaire-example-gcs")
	...
	func runQuestionnaire4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRQuestionnaire {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "questionnaire-example")

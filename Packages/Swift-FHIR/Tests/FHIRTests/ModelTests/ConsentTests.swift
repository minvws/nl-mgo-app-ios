...
class ConsentTests: XCTestCase {
	...
	func runConsent1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-Emergency")
	...
	func runConsent2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-grantor")
	...
	func runConsent3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-notAuthor")
	...
	func runConsent4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-notOrg")
	...
	func runConsent5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-notThem")
	...
	func runConsent6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-notThis")
	...
	func runConsent7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-notTime")
	...
	func runConsent8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-Out")
	...
	func runConsent9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-pkb")
	...
	func runConsent10(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "consent-example-signature")

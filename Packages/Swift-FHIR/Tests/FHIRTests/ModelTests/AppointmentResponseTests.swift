...
class AppointmentResponseTests: XCTestCase {
	...
	func runAppointmentResponse1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAppointmentResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "appointmentresponse-example")
	...
	func runAppointmentResponse2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAppointmentResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "appointmentresponse-example-req")

...
class SpecimenTests: XCTestCase {
	...
	func runSpecimen1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSpecimen {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "specimen-example-isolate")
	...
	func runSpecimen2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSpecimen {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "specimen-example-serum")
	...
	func runSpecimen3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSpecimen {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "specimen-example-urine")
	...
	func runSpecimen4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSpecimen {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "specimen-example")

...
class NamingSystemTests: XCTestCase {
	...
	func runNamingSystem1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRNamingSystem {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "namingsystem-example-id")
	...
	func runNamingSystem2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRNamingSystem {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "namingsystem-example-replaced")
	...
	func runNamingSystem3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRNamingSystem {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "namingsystem-example")

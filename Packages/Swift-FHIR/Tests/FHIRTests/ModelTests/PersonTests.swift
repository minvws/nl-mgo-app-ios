...
class PersonTests: XCTestCase {
	...
	func instantiateFrom(filename: String) throws -> SwiftFHIRPerson {
	...
	@discardableResult
	func runPerson1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRPerson {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "person-example-f002-ariadne")
	...
	@discardableResult
	func runPerson2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRPerson {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "person-example")

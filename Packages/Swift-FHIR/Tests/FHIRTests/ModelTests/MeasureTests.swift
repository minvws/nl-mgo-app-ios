...
class MeasureTests: XCTestCase {
	...
	func runMeasure1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measure-cms146-example")
	...
	func runMeasure2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measure-component-a-example")
	...
	func runMeasure3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measure-component-b-example")
	...
	func runMeasure4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measure-composite-example")
	...
	func runMeasure5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasure {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measure-predecessor-example")

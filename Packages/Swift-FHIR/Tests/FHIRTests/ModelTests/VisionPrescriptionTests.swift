...
class VisionPrescriptionTests: XCTestCase {
	...
	func runVisionPrescription1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRVisionPrescription {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "visionprescription-example-1")
	...
	func runVisionPrescription2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRVisionPrescription {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "visionprescription-example")

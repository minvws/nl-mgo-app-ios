...
class MeasureReportTests: XCTestCase {
	...
	func runMeasureReport1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasureReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measurereport-cms146-cat1-example")
	...
	func runMeasureReport2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasureReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measurereport-cms146-cat2-example")
	...
	func runMeasureReport3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMeasureReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "measurereport-cms146-cat3-example")

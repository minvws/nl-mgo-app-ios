...
class SearchParameterTests: XCTestCase {
	...
	func runSearchParameter1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSearchParameter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "searchparameter-example-extension")
	...
	func runSearchParameter2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSearchParameter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "searchparameter-example-reference")
	...
	func runSearchParameter3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSearchParameter {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "searchparameter-example")

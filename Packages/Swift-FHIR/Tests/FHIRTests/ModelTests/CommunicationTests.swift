...
class CommunicationTests: XCTestCase {
	...
	func runCommunication1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCommunication {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "communication-example-fm-attachment")
	...
	func runCommunication2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCommunication {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "communication-example-fm-solicited-attachment")
	...
	func runCommunication3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCommunication {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "communication-example")

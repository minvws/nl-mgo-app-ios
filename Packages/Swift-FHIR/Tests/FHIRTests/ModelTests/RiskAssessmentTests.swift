...
class RiskAssessmentTests: XCTestCase {
	...
	func runRiskAssessment1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRiskAssessment {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "riskassessment-example-cardiac")
	...
	func runRiskAssessment2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRiskAssessment {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "riskassessment-example-population")
	...
	func runRiskAssessment3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRiskAssessment {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "riskassessment-example-prognosis")
	...
	func runRiskAssessment4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRiskAssessment {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "riskassessment-example")

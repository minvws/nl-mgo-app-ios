...
class ImagingStudyTests: XCTestCase {
	...
	func runImagingStudy1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRImagingStudy {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "imagingstudy-example-xr")
	...
	func runImagingStudy2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRImagingStudy {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "imagingstudy-example")

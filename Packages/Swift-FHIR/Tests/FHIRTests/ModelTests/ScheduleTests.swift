...
class ScheduleTests: XCTestCase {
	...
	func runSchedule1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSchedule {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "schedule-example")
	...
	func runSchedule2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSchedule {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "schedule-provider-location1-example")
	...
	func runSchedule3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSchedule {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "schedule-provider-location2-example")

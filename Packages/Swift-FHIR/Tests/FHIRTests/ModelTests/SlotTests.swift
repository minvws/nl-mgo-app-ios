...
class SlotTests: XCTestCase {
	...
	func runSlot1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSlot {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "slot-example-busy")
	...
	func runSlot2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSlot {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "slot-example-tentative")
	...
	func runSlot3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSlot {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "slot-example-unavailable")
	...
	func runSlot4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSlot {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "slot-example")

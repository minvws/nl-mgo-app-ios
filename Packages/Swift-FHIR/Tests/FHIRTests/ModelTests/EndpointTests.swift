...
class EndpointTests: XCTestCase {
	...
	func runEndpoint1(_ json: FHIRJSON? = nil) throws -> SwiftFHIREndpoint {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "endpoint-example-iid")
	...
	func runEndpoint2(_ json: FHIRJSON? = nil) throws -> SwiftFHIREndpoint {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "endpoint-example-wadors")
	...
	func runEndpoint3(_ json: FHIRJSON? = nil) throws -> SwiftFHIREndpoint {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "endpoint-example")

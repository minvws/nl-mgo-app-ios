...
class AuditEventTests: XCTestCase {
	...
	func runAuditEvent1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "audit-event-example-login")
	...
	func runAuditEvent2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "audit-event-example-logout")
	...
	func runAuditEvent3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "audit-event-example-media")
	...
	func runAuditEvent4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "audit-event-example-pixQuery")
	...
	func runAuditEvent5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "audit-event-example-search")
	...
	func runAuditEvent6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "audit-event-example-vread")
	...
	func runAuditEvent7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "auditevent-example-disclosure")
	...
	func runAuditEvent8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAuditEvent {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "auditevent-example")

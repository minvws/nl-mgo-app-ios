...
class ActivityDefinitionTests: XCTestCase {
	...
	func runActivityDefinition1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "activitydefinition-example")
	...
	func runActivityDefinition2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "activitydefinition-medicationorder-example")
	...
	func runActivityDefinition3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "activitydefinition-predecessor-example")
	...
	func runActivityDefinition4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "activitydefinition-procedurerequest-example")
	...
	func runActivityDefinition5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "activitydefinition-supplyrequest-example")

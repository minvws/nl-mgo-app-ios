...
class TaskTests: XCTestCase {
	...
	func runTask1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRTask {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "task-example1")
	...
	func runTask2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRTask {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "task-example2")
	...
	func runTask3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRTask {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "task-example3")
	...
	func runTask4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRTask {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "task-example4")
	...
	func runTask5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRTask {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "task-example5")
	...
	func runTask6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRTask {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "task-example6")

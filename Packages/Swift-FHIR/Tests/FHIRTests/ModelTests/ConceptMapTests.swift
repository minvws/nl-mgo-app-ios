...
class ConceptMapTests: XCTestCase {
	...
	func runConceptMap1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConceptMap {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "conceptmap-example-2")
	...
	func runConceptMap2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConceptMap {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "conceptmap-example-specimen-type")
	...
	func runConceptMap3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConceptMap {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "conceptmap-example")

...
class EligibilityResponseTests: XCTestCase {
	...
	func runEligibilityResponse1(_ json: FHIRJSON? = nil) throws -> SwiftFHIREligibilityResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "eligibilityresponse-example-benefits-2")
	...
	func runEligibilityResponse2(_ json: FHIRJSON? = nil) throws -> SwiftFHIREligibilityResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "eligibilityresponse-example-benefits")
	...
	func runEligibilityResponse3(_ json: FHIRJSON? = nil) throws -> SwiftFHIREligibilityResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "eligibilityresponse-example-error")
	...
	func runEligibilityResponse4(_ json: FHIRJSON? = nil) throws -> SwiftFHIREligibilityResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "eligibilityresponse-example")

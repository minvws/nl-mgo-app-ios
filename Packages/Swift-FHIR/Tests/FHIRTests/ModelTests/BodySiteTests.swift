...
class BodySiteTests: XCTestCase {
	...
	func runBodySite1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBodySite {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "bodysite-example-fetus")
	...
	func runBodySite2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBodySite {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "bodysite-example-skin-patch")
	...
	func runBodySite3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBodySite {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "bodysite-example-tumor")

...
class ProcessRequestTests: XCTestCase {
	...
	func runProcessRequest1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-poll-eob")
	...
	func runProcessRequest2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-poll-exclusive")
	...
	func runProcessRequest3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-poll-inclusive")
	...
	func runProcessRequest4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-poll-payrec")
	...
	func runProcessRequest5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-poll-specific")
	...
	func runProcessRequest6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-reprocess")
	...
	func runProcessRequest7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-reverse")
	...
	func runProcessRequest8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example-status")
	...
	func runProcessRequest9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processrequest-example")

...
class DataElementTests: XCTestCase {
	...
	func runDataElement1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDataElement {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "dataelement-example")
	...
	func runDataElement2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDataElement {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "dataelement-labtestmaster-example")

...
class RelatedPersonTests: XCTestCase {
	...
	func runRelatedPerson1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRelatedPerson {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "relatedperson-example-f001-sarah")
	...
	func runRelatedPerson2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRelatedPerson {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "relatedperson-example-f002-ariadne")
	...
	func runRelatedPerson3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRelatedPerson {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "relatedperson-example-peter")
	...
	func runRelatedPerson4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRRelatedPerson {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "relatedperson-example")

...
class SubstanceTests: XCTestCase {
	...
	func runSubstance1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubstance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "substance-example-amoxicillin-clavulanate")
	...
	func runSubstance2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubstance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "substance-example-f201-dust")
	...
	func runSubstance3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubstance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "substance-example-f202-staphylococcus")
	...
	func runSubstance4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubstance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "substance-example-f203-potassium")
	...
	func runSubstance5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubstance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "substance-example-silver-nitrate-product")
	...
	func runSubstance6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubstance {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "substance-example")

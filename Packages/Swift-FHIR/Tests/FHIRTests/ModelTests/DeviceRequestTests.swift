...
class DeviceRequestTests: XCTestCase {
	...
	func runDeviceRequest1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDeviceRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "devicerequest-example-insulinpump")
	...
	func runDeviceRequest2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDeviceRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "devicerequest-example")

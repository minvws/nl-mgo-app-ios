...
class DiagnosticReportTests: XCTestCase {
	...
	func runDiagnosticReport1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-dxa")
		...
		XCTAssertEqual(inst.performer?[0].role?.text, "Radiologist")
	...
	func runDiagnosticReport2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-f001-bloodexam")
	...
	func runDiagnosticReport3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-f201-brainct")
	...
	func runDiagnosticReport4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-f202-bloodculture")
	...
	func runDiagnosticReport5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-ghp")
	...
	func runDiagnosticReport6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-gingival-mass")
	...
	func runDiagnosticReport7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-lipids")
	...
	func runDiagnosticReport8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-papsmear")
	...
	func runDiagnosticReport9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-pgx")
		...
		XCTAssertEqual(inst.performer?[0].actor?.reference, "Organization/4829")
	...
	func runDiagnosticReport10(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDiagnosticReport {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "diagnosticreport-example-ultrasound")
		...
		XCTAssertEqual(inst.image?[0].link?.reference, "Media/1.2.840.11361907579238403408700.3.0.24.19970327150033")
		XCTAssertEqual(inst.issued?.description, "2012-12-01T12:00:00+01:00")
		XCTAssertEqual(inst.performer?[0].actor?.reference, "Practitioner/example")
		XCTAssertEqual(inst.status, DiagnosticReportStatus(rawValue: "final")!)

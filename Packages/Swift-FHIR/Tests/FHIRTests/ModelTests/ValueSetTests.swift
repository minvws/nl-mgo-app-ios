...
class ValueSetTests: XCTestCase {
	...
	func runValueSet1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRValueSet {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "valueset-example-expansion")
	...
	func runValueSet2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRValueSet {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "valueset-example-inactive")
	...
	func runValueSet3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRValueSet {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "valueset-example-intensional")
	...
	func runValueSet4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRValueSet {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "valueset-example-yesnodontknow")
	...
	func runValueSet5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRValueSet {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "valueset-example")
	...
	func runValueSet6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRValueSet {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "valueset-list-example-codes")
		
		XCTAssertEqual(inst.compose?.include?[0].system?.absoluteString, "http://hl7.org/fhir/list-example-use-codes")
		XCTAssertEqual(inst.contact?[0].telecom?[0].system, ContactPointSystem(rawValue: "url")!)
		XCTAssertEqual(inst.contact?[0].telecom?[0].value, "http://hl7.org/fhir")
		XCTAssertEqual(inst.date?.description, "2019-10-24T11:53:00+11:00")
		...
		XCTAssertEqual(inst.meta?.lastUpdated?.description, "2019-10-24T11:53:00+11:00")
		XCTAssertEqual(inst.meta?.profile?[0].absoluteString, "http://hl7.org/fhir/StructureDefinition/shareablevalueset")
		...
		XCTAssertEqual(inst.version, "3.0.2")

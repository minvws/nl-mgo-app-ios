...
class DeviceTests: XCTestCase {
	...
	func runDevice1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-f001-feedingtube")
	...
	func runDevice2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-ihe-pcd")
	...
	func runDevice3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-pacemaker")
	...
	func runDevice4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-software")
	...
	func runDevice5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-udi1")
	...
	func runDevice6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-udi2")
	...
	func runDevice7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-udi3")
	...
	func runDevice8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example-udi4")
	...
	func runDevice9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRDevice {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "device-example")

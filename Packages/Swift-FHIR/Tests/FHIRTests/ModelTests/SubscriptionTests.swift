...
class SubscriptionTests: XCTestCase {
	...
	func runSubscription1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubscription {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "subscription-example-error")
	...
	func runSubscription2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRSubscription {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "subscription-example")

...
class LocationTests: XCTestCase {
	...
	func runLocation1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "location-example-ambulance")
	...
	func runLocation2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "location-example-hl7hq")
	...
	func runLocation3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "location-example-patients-home")
	...
	func runLocation4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "location-example-room")
	...
	func runLocation5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "location-example-ukpharmacy")
	...
	func runLocation6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "location-example")

...
class CapabilityStatementTests: XCTestCase {
	...
	func runCapabilityStatement1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCapabilityStatement {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "capabilitystatement-example")
	...
	func runCapabilityStatement2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCapabilityStatement {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "capabilitystatement-phr-example")

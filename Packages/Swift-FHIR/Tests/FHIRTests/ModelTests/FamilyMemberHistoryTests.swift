...
class FamilyMemberHistoryTests: XCTestCase {
	...
	func runFamilyMemberHistory1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRFamilyMemberHistory {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "familymemberhistory-example-mother")
	...
	func runFamilyMemberHistory2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRFamilyMemberHistory {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "familymemberhistory-example-father")

...
class EligibilityRequestTests: XCTestCase {
	...
	func runEligibilityRequest1(_ json: FHIRJSON? = nil) throws -> SwiftFHIREligibilityRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "eligibilityrequest-example-2")
	...
	func runEligibilityRequest2(_ json: FHIRJSON? = nil) throws -> SwiftFHIREligibilityRequest {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "eligibilityrequest-example")

...
class FlagTests: XCTestCase {
	...
	func runFlag1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRFlag {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "flag-example-encounter")
	...
	func runFlag2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRFlag {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "flag-example")

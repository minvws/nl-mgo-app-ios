...
class MediaTests: XCTestCase {
	...
	func runMedia1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMedia {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "media-example-dicom")
		...
		XCTAssertEqual(inst.id, "1.2.840.11361907579238403408700.3.0.24.19970327150033")
		...
		XCTAssertEqual(inst.identifier?[0].value, "urn:oid:1.2.840.11361907579238403408700.3.0.24.19970327150033")
	...
	func runMedia2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMedia {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "media-example-sound")
	...
	func runMedia3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMedia {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "media-example-xray")
	...
	func runMedia4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRMedia {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "media-example")

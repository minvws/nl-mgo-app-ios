...
class AppointmentTests: XCTestCase {
	...
	func runAppointment1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAppointment {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "appointment-example-request")
	...
	func runAppointment2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAppointment {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "appointment-example")
	...
	func runAppointment3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRAppointment {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "appointment-example2doctors")

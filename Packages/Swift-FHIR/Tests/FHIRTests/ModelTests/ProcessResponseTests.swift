...
class ProcessResponseTests: XCTestCase {
	...
	func runProcessResponse1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processresponse-example-error")
	...
	func runProcessResponse2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processresponse-example-pended")
	...
	func runProcessResponse3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRProcessResponse {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "processresponse-example")

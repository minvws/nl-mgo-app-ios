...
class OperationOutcomeTests: XCTestCase {
	...
	func runOperationOutcome1(_ json: FHIRJSON? = nil) throws -> SwiftFHIROperationOutcome {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "operationoutcome-example-allok")
	...
	func runOperationOutcome2(_ json: FHIRJSON? = nil) throws -> SwiftFHIROperationOutcome {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "operationoutcome-example-break-the-glass")
	...
	func runOperationOutcome3(_ json: FHIRJSON? = nil) throws -> SwiftFHIROperationOutcome {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "operationoutcome-example-exception")
	...
	func runOperationOutcome4(_ json: FHIRJSON? = nil) throws -> SwiftFHIROperationOutcome {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "operationoutcome-example-searchfail")
	...
	func runOperationOutcome5(_ json: FHIRJSON? = nil) throws -> SwiftFHIROperationOutcome {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "operationoutcome-example-validationfail")
	...
	func runOperationOutcome6(_ json: FHIRJSON? = nil) throws -> SwiftFHIROperationOutcome {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "operationoutcome-example")

...
class ObservationTests: XCTestCase {
	...
	func runObservation1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-10minute-apgar-score")
	...
	func runObservation2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-1minute-apgar-score")
	...
	func runObservation3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-20minute-apgar-score")
	...
	func runObservation4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-2minute-apgar-score")
	...
	func runObservation5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-5minute-apgar-score")
	...
	func runObservation6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-bloodpressure-cancel")
	...
	func runObservation7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-bloodpressure-dar")
	...
	func runObservation8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-bloodpressure")
	...
	func runObservation9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-bmd")
	...
	func runObservation10(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "observation-example-bmi")

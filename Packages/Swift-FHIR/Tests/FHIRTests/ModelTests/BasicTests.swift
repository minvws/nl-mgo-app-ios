...
class BasicTests: XCTestCase {
	...
	func runBasic1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBasic {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "basic-example-narrative")
	...
	func runBasic2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBasic {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "basic-example")
	...
	func runBasic3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBasic {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "basic-example2")

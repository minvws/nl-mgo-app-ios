...
final class HealthDataFlowTests: XCTestCase {
	...
	func testHealthDataFlow_BGZ() {
		...
		AppRobot()
			...
			.swipeDownToRowHeading("Reden wijzigen of stoppen gebruik")
	...
	func testHealthDataFlow_GP() {
		...
		AppRobot()
			...
			.swipeDownToRowHeading("Test datum tijd")
	...
	func testHealthDataFlow_Document() {
		...
		AppRobot()
			...
			.swipeDownToSection("Example PDF - Anterior Cervical Discectomy Fusion - Discharge Summary")
	...
	func testHealthDataFlow_Vaccination() {
		...
		AppRobot()
			...
			.swipeDownToRowHeading("Toelichting")
			.verifySectionRowExists("Toelichting", value: "Niet bekend")

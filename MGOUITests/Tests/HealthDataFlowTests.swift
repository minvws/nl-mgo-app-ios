...
final class HealthDataFlowTests: XCTestCase {
	...
	func testHealthDataFlow_BGZ() {
		...
		AppRobot()
			...
			.swipeDownToSection("Voorgeschreven door")
			...
			.swipeDownToRowHeading("Medicatie gebruik stop type")
			.swipeDownToReferenceButton("Onderwerp", value: "Johan XXX_Helleman")
			...
			.swipeDownToSection("Gebruiksperiode")
			...
			.swipeDownToRowHeading("Interval")
			...
			.swipeDownToRowHeading("Toedientijd")
	...
	func testHealthDataFlow_GP() {
		...
		AppRobot()
			...
			.swipeDownToRowHeading("Maximale waarde")
	...
	func testHealthDataFlow_Document() {
		...
		AppRobot()
			...
			.verifySectionRowExists("Onderwerp", value: "E XXX_Baltus")
			.swipeDownToRowHeading("Specialist")
			.verifySectionRowExists("Specialist", value: "A.F. Snijder")
			...
			.swipeDownToRowHeading("Faciliteit")
	...
	func testHealthDataFlow_Vaccination() {
		...
		AppRobot()
			...
			.swipeDownToRowHeading("Toediener")
			.verifySectionRowExists("Toediener", value: "GGD Gelderland-Zuid")

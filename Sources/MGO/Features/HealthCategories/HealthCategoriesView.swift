	...
	init(coordinator: (any Coordinator)? = nil, mode: HealthCategoriesViewMode) {
		...
		self.state = HealthCategoriesViewState(
			...
			healthCategories: [
				...
				CategoryButton(id: HealthCategories.Category.patient.rawValue, title: "hc_patient.heading", state: .loading, box: 1),
				CategoryButton(id: HealthCategories.Category.alerts.rawValue, title: "hc_alerts.heading", state: .loading, box: 1),
				CategoryButton(id: HealthCategories.Category.payment.rawValue, title: "hc_payment.heading", state: .loading, box: 1),

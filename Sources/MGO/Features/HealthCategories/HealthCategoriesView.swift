	...
	init(coordinator: (any Coordinator)? = nil, mode: HealthCategoriesViewMode) {
		...
		self.state = HealthCategoriesViewState(
			...
			healthCategories: [
				...
				CategoryButton(id: HealthCategories.Category.alerts.rawValue, title: "health_category.alerts", state: .notAvailabe, box: 1),
				...
				CategoryButton(id: HealthCategories.Category.mental.rawValue, title: "health_category.mental", state: .notAvailabe, box: 1),
				CategoryButton(id: HealthCategories.Category.lifestyle.rawValue, title: "health_category.lifestyle", state: .notAvailabe, box: 1)
			],

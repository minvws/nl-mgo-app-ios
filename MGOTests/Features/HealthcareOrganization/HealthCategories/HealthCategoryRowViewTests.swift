...
class HealthCategoryRowViewTests: XCTestCase {
	...
	func test_empty() {
		...
		// Given
		let sut = HealthCategoryRowView(block: CategoryButton(id: 1, title: "Medicijnen", state: .empty))
	...
	func test_loading() {
		...
		// Given
		let sut = HealthCategoryRowView(block: CategoryButton(id: 1, title: "Medicijnen", state: .loading))
	...
	func test_loaded() {
		...
		// Given
		let sut = HealthCategoryRowView(block: CategoryButton(id: 1, title: "Medicijnen", state: .loaded))

...
class FavoriteCategoryRowViewTests: XCTestCase {
	...
	@MainActor func test_empty() {
		...
		// Given
		let sut = FavoriteRowView(category: Generator.healthCategory, state: .empty)
	...
	@MainActor func test_loading() {
		...
		// Given
		let sut = FavoriteRowView(category: Generator.healthCategory, state: .loading)
	...
	@MainActor func test_loaded() {
		...
		// Given
		let sut = FavoriteRowView(category: Generator.healthCategory, state: .loaded)

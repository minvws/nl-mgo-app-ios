...
final class DevicesHealthCategoryViewTests: XCTestCase {
	...
	func test_stateEmpty() {
		...
		servicesSpies.dataStoreSpy.stubbedGetCategoryIdResult = .success([
			MgoResourceRecord(categoryId: "\(HealthCategories.Category.devices.rawValue)", organizationId: healthcareOrganization.identifier, resources: [])]
		)
		let content = NavigationView { sut }
	...
	func test_stateList() throws {
		...
		servicesSpies.dataStoreSpy.stubbedGetCategoryIdResult = .success([
			MgoResourceRecord(categoryId: "\(HealthCategories.Category.devices.rawValue)", organizationId: healthcareOrganization.identifier, resources: [resource])]
		)

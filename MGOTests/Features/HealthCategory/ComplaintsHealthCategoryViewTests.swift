...
final class ComplaintsHealthCategoryViewTests: XCTestCase {
	...
	override func setUp() {
		...
		viewModel = ComplaintsHealthCategoryViewModel(
	...
	func test_search_itemFound() throws {
		...
		// When
		viewModel.searchText = "Amyotrofe"
